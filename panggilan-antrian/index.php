...
<head>
  ...
  <meta name="author" content="Deygo Dimas Andrianto Pradana">
  <!-- Title -->
  <title>Aplikasi Antrian</title>
  <!-- Favicon icon -->
  <link rel="shortcut icon" href="../assets/img/Logo Kota Surabaya.png" type="image/x-icon">
  <!-- Bootstrap CSS -->
      ...
      <div class="d-flex flex-column flex-md-row px-4 py-3 mb-4 bg-white rounded-2 shadow-sm">
        ...
        <div class="ms-5 ms-md-0 pt-md-3 pb-md-0">
          <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="UPTD Labkesda Kota Surabaya"><i class="bi-house-fill text-success"></i></a></li>
  ...
  <footer class="footer mt-auto py-4">
    <div class="container">
      ...
      <div class="copyright text-center mb-2 mb-md-0">
        &copy; 2023 - <a href="UPTD Labkesda Kota Surabaya" target="_blank" class="text-danger text-decoration-none">UPTD Labkesda Kota Surabaya</a>. All rights reserved.
      </div>
    </div>
  </footer>
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#tabel-antrian tbody').on('click', 'button', function() {
        ...
        setTimeout(function() {
          responsiveVoice.speak("Nomor Antrian, " + data["no_antrian"] + ", menuju, loket, Administrasi", "Indonesian Male", {
            rate: 1.0,
            pitch: 1,
            volume: 3
          });
